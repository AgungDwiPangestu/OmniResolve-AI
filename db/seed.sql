...
('QHM-DEL-0031105', 'ORD-QHM-003', 'J&T Express', 'delivered_with_damage_report', 'damaged_at_pickup', TRUE, '[{"time": "2026-05-19 08:30", "status": "Inspeksi gudang: kemasan rak dinding ditemukan penyok/lecet sebelum pickup — tetap dikirim atas instruksi supervisor", "location": "Gudang Furnitur F1"}, {"time": "2026-05-19 14:00", "status": "Terkirim — penerima mencatat kondisi packaging rusak di bagian sudut", "location": "Yogyakarta"}]'::jsonb),
...
('QHM-DEL-0068314', 'ORD-QHM-006', 'GoSend', 'delivered_with_damage_report', 'damaged_at_pickup', TRUE, '[{"time": "2026-05-19 09:00", "status": "Gudang Cat C1: ditemukan 1 kaleng penyok & tutup tidak rapat saat inspeksi sebelum pickup", "location": "Gudang Cat C1"}, {"time": "2026-05-19 13:30", "status": "Terkirim — penerima melaporkan cat tumpah sebagian", "location": "Yogyakarta"}]'::jsonb),
...
('QHM-DEL-0091715', 'ORD-QHM-009', 'Armada Qhomemart', 'delivered_with_damage_report', 'damaged_at_pickup', TRUE, '[{"time": "2026-05-19 08:00", "status": "Gudang Sanitary D3: water heater ditemukan tabung penyok — diduga tertimpa tumpukan saat penyimpanan", "location": "Gudang Sanitary D3"}, {"time": "2026-05-19 15:00", "status": "Terkirim — penerima menolak tanda tangan karena kondisi kardus rusak parah", "location": "Yogyakarta"}]'::jsonb),
('QHM-DEL-0108674', 'ORD-QHM-010', 'Dakota Cargo', 'delivered_with_damage_report', 'damaged_at_pickup', TRUE, '[{"time": "2026-05-19 07:30", "status": "Gudang Furnitur F1: meja makan ditemukan kaki meja retak saat wrapping — proses pengiriman dilanjutkan", "location": "Gudang Furnitur F1"}, {"time": "2026-05-19 16:00", "status": "Terkirim — penerima mencatat kerusakan kaki meja", "location": "Yogyakarta"}]'::jsonb),
...
('QHM-DEL-0124920', 'ORD-QHM-012', 'SiCepat', 'delivered_with_damage_report', 'damaged_at_pickup', TRUE, '[{"time": "2026-05-19 09:00", "status": "Gudang Material B2: 1 dari 3 kantong semen ditemukan sobek dan lembab saat loading — kurir diperintahkan tetap kirim", "location": "Gudang Material B2"}, {"time": "2026-05-19 14:30", "status": "Terkirim — penerima mengeluhkan semen sudah menggumpal", "location": "Yogyakarta"}]'::jsonb),
...
('QHM-DEL-0143501', 'ORD-QHM-014', 'GoSend', 'delivered_with_damage_report', 'damaged_at_pickup', TRUE, '[{"time": "2026-05-22 08:30", "status": "Gudang Elektronik H2: kipas angin ditemukan kemasan tergencet — bagian leher dan baling-baling dicurigai rusak saat inspeksi sebelum pickup", "location": "Gudang Elektronik H2"}, {"time": "2026-05-22 13:45", "status": "Terkirim — penerima melaporkan leher kipas patah dan baling-baling tidak berputar", "location": "Yogyakarta"}]'::jsonb),
('QHM-DEL-0157770', 'ORD-QHM-015', 'GrabExpress', 'delivered_with_damage_report', 'damaged_at_pickup', TRUE, '[{"time": "2026-05-19 09:15", "status": "Gudang Dekorasi J3: 2 dari 6 cermin hexagonal retak saat inspeksi packing — kurir diminta lanjut kirim", "location": "Gudang Dekorasi J3"}, {"time": "2026-05-19 14:00", "status": "Terkirim — penerima melaporkan cermin sudah pecah dalam kemasan", "location": "Yogyakarta"}]'::jsonb),
...
('QHM-DEL-0213831', 'ORD-QHM-021', 'JNE Trucking', 'delivered_with_damage_report', 'damaged_at_pickup', TRUE, '[{"time": "2026-05-19 08:45", "status": "Gudang Perkakas G1: set obeng ditemukan kotak rusak/terbuka — beberapa komponen longgar saat pickup", "location": "Gudang Perkakas G1"}, {"time": "2026-05-19 13:00", "status": "Terkirim — penerima melaporkan obeng set tidak lengkap", "location": "Yogyakarta"}]'::jsonb),
...
('QHM-DEL-0273842', 'ORD-QHM-027', 'J&T Express', 'delivered_with_damage_report', 'damaged_at_pickup', TRUE, '[{"time": "2026-05-19 08:00", "status": "Gudang Utama A1: beberapa ubin keramik dalam dus ditemukan retak/pecah akibat tumpukan palet jatuh saat penyimpanan", "location": "Gudang Utama A1"}, {"time": "2026-05-19 14:00", "status": "Terkirim — penerima melaporkan isi dus banyak yang pecah", "location": "Yogyakarta"}]'::jsonb),
...
('QHM-DEL-0298129', 'ORD-QHM-029', 'JNE Trucking', 'delivered_with_damage_report', 'damaged_at_pickup', TRUE, '[{"time": "2026-05-19 09:00", "status": "Gudang Perkakas G1: tang ditemukan berkarat dan blister packaging sobek akibat penyimpanan lembab", "location": "Gudang Perkakas G1"}, {"time": "2026-05-19 14:30", "status": "Terkirim — penerima menolak barang karena kondisi berkarat", "location": "Yogyakarta"}]'::jsonb),
...
('QHM-DEL-0331908', 'ORD-QHM-033', 'Armada Qhomemart', 'delivered_with_damage_report', 'damaged_at_pickup', TRUE, '[{"time": "2026-05-19 08:30", "status": "Gudang Cat C1: wadah dempul kayu ditemukan retak dan isi bocor sebagian saat pengemasan ulang", "location": "Gudang Cat C1"}, {"time": "2026-05-19 13:30", "status": "Terkirim — penerima melaporkan dempul mengeras tidak bisa dipakai", "location": "Yogyakarta"}]'::jsonb),
...
('QHM-DEL-0424349', 'ORD-QHM-042', 'Dakota Cargo', 'delivered_with_damage_report', 'damaged_at_pickup', TRUE, '[{"time": "2026-05-19 07:45", "status": "Gudang Furnitur F1: rangka kursi kantor ditemukan bengkok pada sandaran — diduga tertimpa beban berat di rak penyimpanan", "location": "Gudang Furnitur F1"}, {"time": "2026-05-19 15:30", "status": "Terkirim — penerima melaporkan sandaran kursi tidak bisa ditegakkan", "location": "Yogyakarta"}]'::jsonb),
...
('QHM-DEL-0481483', 'ORD-QHM-048', 'Indah Logistik', 'delivered_with_damage_report', 'damaged_at_pickup', TRUE, '[{"time": "2026-05-19 09:30", "status": "Gudang Listrik E2: 3 dari 4 bohlam LED ditemukan pecah di dalam kotak akibat jatuh dari rak saat stok opname", "location": "Gudang Listrik E2"}, {"time": "2026-05-19 14:00", "status": "Terkirim — penerima melaporkan bohlam sudah tidak berfungsi", "location": "Yogyakarta"}]'::jsonb),
...
('QHM-DEL-0561307', 'ORD-QHM-056', 'Indah Logistik', 'delivered_with_damage_report', 'damaged_at_pickup', TRUE, '[{"time": "2026-05-19 08:15", "status": "Gudang Dekorasi J3: lukisan canvas ditemukan lembab dan berjamur di sudut — diduga area penyimpanan terkena rembes air", "location": "Gudang Dekorasi J3"}, {"time": "2026-05-19 13:00", "status": "Terkirim — penerima melaporkan lukisan bau apek dan berjamur", "location": "Yogyakarta"}]'::jsonb),
...
('QHM-DEL-0603866', 'ORD-QHM-060', 'SiCepat', 'delivered_with_damage_report', 'damaged_at_pickup', TRUE, '[{"time": "2026-05-19 09:00", "status": "Gudang Elektronik H2: dispenser ditemukan retak pada bagian keran dan tampungan air — jatuh saat proses loading ke armada", "location": "Gudang Elektronik H2"}, {"time": "2026-05-19 14:30", "status": "Terkirim — penerima melaporkan dispenser bocor tidak bisa digunakan", "location": "Yogyakarta"}]'::jsonb),
...
('QHM-DEL-0661572', 'ORD-QHM-066', 'Dakota Cargo', 'delivered_with_damage_report', 'damaged_at_pickup', TRUE, '[{"time": "2026-05-19 08:45", "status": "Gudang Cat C1: kaleng cat tembok ditemukan penyok dan tutup tidak rapat — cat mengering sebagian di pinggiran", "location": "Gudang Cat C1"}, {"time": "2026-05-19 14:00", "status": "Terkirim — penerima melaporkan cat sudah mengental dan berbintil", "location": "Yogyakarta"}]'::jsonb),
