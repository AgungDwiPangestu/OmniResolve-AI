const en = {
  ...
  "conversation.claude": "OmniResolve Agent",
  ...
  "conversation.noConversation":
    "No conversation yet. Start a session to begin.",
  ...
  "tour.steps.singleWelcome.title": "Welcome to Qhome Virtual Office",
  "tour.steps.singleWelcome.description":
    "This pixel art office shows your Qhome OmniResolve sessions in real time. Let's take a quick look around.",
