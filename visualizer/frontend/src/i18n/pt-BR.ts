...
const ptBR: Record<TranslationKey, string> = {
  ...
  "conversation.noConversation":
    "Sem conversa ainda. Inicie uma sessão para começar.",
  ...
  "tour.steps.singleWelcome.title": "Bem-vindo ao Qhome Virtual Office",
  "tour.steps.singleWelcome.description":
    "Este escritório em pixel art mostra suas sessões de Qhome OmniResolve em tempo real. Vamos dar uma olhada rápida.",
