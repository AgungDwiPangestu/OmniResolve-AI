...
const es: Record<TranslationKey, string> = {
  ...
  "conversation.claude": "Agente OmniResolve",
  ...
  "conversation.noConversation":
    "Aún no hay conversaciones. Inicia una sesión para comenzar.",
  ...
  "tour.steps.singleWelcome.title": "Bienvenido a Qhome Virtual Office",
  "tour.steps.singleWelcome.description":
    "Esta oficina en pixel art muestra tus sesiones de Qhome OmniResolve en tiempo real. Hagamos un recorrido rápido.",
